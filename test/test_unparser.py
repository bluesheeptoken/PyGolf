...
class TestUnparser(unittest.TestCase):
    ...
    def test_unparse_for(self):
        ...
        self.assertEqual(
            self.unparser.unparse_for(async_for, True),
...
''')
        ...
        self.assertEqual(
            self.unparser.unparse_for(for_def, False),
            "for thing in things:pass"
        )
...
''')
    ...
    def test_unparse_Arguments(self):
        ...
        self.assertEqual(
            self.unparser.unparse_Arguments(node),
            "foo,bar=None"
        )
    ...
    def test_unparse_Assert(self):
        ...
        self.assertEqual(
            self.unparser.unparse_Assert(assert_with_message),
            "assert True,'message'"
        )

        assert_without_message = extract_node("assert True")
        self.assertEqual(
            self.unparser.unparse_Assert(assert_without_message),
            "assert True"
        )
    ...
    def test_unparse_Assign(self):
        ...
        self.assertEqual(
            self.unparser.unparse_Assign(assign_several),
            "*a,b=2,3,5"
        )

        assign_single_starred = extract_node("*a, = 2, 3, 5")
        self.assertEqual(
            self.unparser.unparse_Assign(assign_single_starred),
            "*a,=2,3,5"
        )

        assign_single_not_starred = extract_node("a = 2")
        self.assertEqual(
            self.unparser.unparse_Assign(assign_single_not_starred),
            "a=2"
        )

        multiple_targets = extract_node("a = b = 2")
        self.assertEqual(
            self.unparser.unparse_Assign(multiple_targets),
            "a=b=2"
        )
    ...
    def test_unparse_AssignAttr(self):
        ...
        self.assertEqual(
            self.unparser.unparse_Assign(node),
            "self.attribute=2"
        )
    ...
    def test_unparse_Attribute(self):
        ...
        self.assertEqual(
            self.unparser.unparse_Attribute(node),
            "snake.colour"
        )
    ...
    def test_unparse_AugAssign(self):
        ...
        self.assertEqual(
            self.unparser.unparse_AugAssign(node),
            "a*=2"
        )
    ...
    def test_unparse_BoolOP(self):
        ...
        self.assertEqual(
            self.unparser.unparse_BoolOp(node),
            "True and''and False"
        )
    ...
    def test_unparse_Call(self):
        ...
        self.assertEqual(
            self.unparser.unparse_Call(node),
            "f(a,b=2,c=3)"
        )
...
class A(B,C):
 ...
 def __init__(self):pass"""
    ...
    def test_unparse_Compare(self):
        ...
        self.assertEqual(
            self.unparser.unparse_Compare(node),
            "a<=2>b"
        )
    ...
    def test_unparse_Comprehension(self):
        ...
        self.assertEqual(
            self.unparser.unparse_Comprehension(node),
            "for i in range(10)if i<5 if i>8"
        )
    ...
    def test_unparse_Const(self):
        ...
        self.assertEqual(
            self.unparser.unparse_Const(const),
            "2"
        )
        ...
        self.assertEqual(
            self.unparser.unparse_Const(string_const),
            "'golf'"
        )
    ...
    def test_unparse_Delete(self):
        ...
        self.assertEqual(
            self.unparser.unparse_Delete(node),
            "del a,self.b"
        )
    ...
    def test_unparse_Dict(self):
        ...
        self.assertEqual(
            self.unparser.unparse_Dict(node),
            "{1:1,'a':'b'}"
        )
...
""").handlers[0]
        self.assertEqual(
            self.unparser.unparse_ExceptHandler(node),
    ...
    def test_unparse_Global(self):
        ...
        self.assertEqual(
            self.unparser.unparse_Global(node),
            "global a,b"
        )
    ...
    def test_unparse_If(self):
        ...
        self.assertEqual(
            self.unparser.unparse_If(if_node),
            "if condition:pass"
        )

        if_else_node = extract_node("""if {}:pass
else:pass""")
    ...
    def test_unparse_IfExp(self):
        ...
        self.assertEqual(
            self.unparser.unparse_IfExp(node),
            "5if{}else 2"
        )
    ...
    def test_unparse_Import(self):
        ...
        self.assertEqual(
            self.unparser.unparse_Import(node),
    ...
    def test_unparse_Lambda(self):
        ...
        self.assertEqual(
            self.unparser.unparse_Lambda(node),
            "lambda x,y:x,y"
        )
    ...
    def test_unparse_List(self):
        ...
        self.assertEqual(
            self.unparser.unparse_List(node),
            "[2,3,5]"
        )
    ...
    def test_unparse_ListComp(self):
        ...
        self.assertEqual(
            self.unparser.unparse_ListComp(node),
            "[2for x in range(10)]"
        )

    def test_unparse_Module(self):
        node = parse("""for i in range(10):pass
try:pass
except E:pass
""")
        self.assertEqual(
...
try:pass
    ...
    def test_unparse_Nonlocal(self):
        ...
        self.assertEqual(
            self.unparser.unparse_Nonlocal(node),
            "nonlocal a,b"
        )
    ...
    def test_unparse_Raise(self):
        ...
        self.assertEqual(
            self.unparser.unparse_Raise(raise_none),
            "raise"
        )
        ...
        self.assertEqual(
            self.unparser.unparse_Raise(raise_call),
            "raise Exception('So bad')from x"
        )
    ...
    def test_unparse_Return(self):
        ...
        self.assertEqual(
            self.unparser.unparse_Return(node),
            "return[]"
        )
    ...
    def test_unparse_Set(self):
        ...
        self.assertEqual(
            self.unparser.unparse_Set(node),
            "{2,3,5}"
        )
    ...
    def test_unparse_SetComp(self):
        ...
        self.assertEqual(
            self.unparser.unparse_SetComp(node),
            "{2for x in range(10)}"
        )
    ...
    def test_unparse_Slice(self):
        ...
        self.assertEqual(
            self.unparser.unparse_Subscript(slice_1),
            "l[1:]"
        )
        ...
        self.assertEqual(
            self.unparser.unparse_Subscript(slice_2),
            "l[1::5]"
        )
        ...
        self.assertEqual(
            self.unparser.unparse_Subscript(slice_3),
            "l[1:2:3]"
        )
        ...
        self.assertEqual(
            self.unparser.unparse_Subscript(slice_4),
            "l[:1:3]"
        )
    ...
    def test_unparse_Subscript(self):
        ...
        self.assertEqual(
            self.unparser.unparse_Subscript(complex_slice),
            "l[1:3:5,3]"
        )
        ...
        self.assertEqual(
            self.unparser.unparse_Subscript(simple_slice),
            "l[1::5]"
        )
...
try:pass
    ...
    def test_unparse_TryFinally(self):
        ...
        self.assertEqual(
            self.unparser.unparse_TryFinally(node),
            "try:pass\nfinally:pass"
        )
    ...
    def test_unparse_UnaryOp(self):
        ...
        self.assertEqual(
            self.unparser.unparse_UnaryOp(node),
            "-3"
        )

    def test_unparse_UnaryOp(self):
        while_else = extract_node("""while True:pass
else:pass
""")
        ...
        self.assertEqual(
            self.unparser.unparse_While(node_while),
            "while True:pass"
        )
    ...
    def test_unparse_Yield(self):
        ...
        self.assertEqual(
            self.unparser.unparse_Yield(node),
            "yield True"
        )
    ...
    def test_unparse_YieldFrom(self):
        ...
        self.assertEqual(
            self.unparser.unparse_YieldFrom(node),
            "yield from True"
        )
